...
- 역할 분담
- 심규보:
  - System Architecture Design: VMware 기반 Nested 가상화 인프라 및 전용 네트워크(L2/L3) 아키텍처 설계
  - Platform Development: FastAPI 기반의 VM 프로비저닝 백엔드 로직 및 사용자 인터페이스(Web) Full-stack 개발
  - Log & Storage Engineering: 비정형 로그 수집 백엔드 구축 및 NFS 기반 공유 스토리지 프로토콜 최적화
